          ...
          <section className='mt-3' aria-labelledby='meetings-heading'>
            ...
            */}
            <div className='mt-2 overflow-x-auto'>
              <table
                id='collectionsboard-meetings-table'
                className='w-full border-collapse text-left'
              >
                <caption
                  id='collectionsboard-meetings-caption'
                  className='sr-only'
                >
                ...
                <thead>
                  <tr className='border-b-2 border-gray-300 dark:border-gray-600 dark:text-white'>
                    <th
                      id='collectionsboard-date-header'
                      scope='col'
                    ...
                    <th
                      id='collectionsboard-agenda-header'
                      scope='col'
                      className='px-2 py-2 font-semibold'
                    >
                      Agenda
                    ...
                    <th
                      id='collectionsboard-minutes-header'
                      scope='col'
                      className='px-2 py-2 font-semibold'
                    >
                      Minutes
                ...
                <tbody>
                  {(collections as Meeting[]).map((eachmeeting, key) => {
                    const rowHeaderId = `collectionsboard-meeting-${key}-date`;
                    ...
                    return (
                      ...
                      >
                        <th
                          id={rowHeaderId}
                          scope='row'
                          headers='collectionsboard-date-header'
                        ...
                        <td
                          headers={`${rowHeaderId} collectionsboard-agenda-header`}
                        ...
                        <td
                          headers={`${rowHeaderId} collectionsboard-minutes-header`}
                          className='px-2 py-2 align-top'
                        >
                          {eachmeeting.minutes ? (
                            <Link
