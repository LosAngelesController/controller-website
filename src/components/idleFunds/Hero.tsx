      ...
      <div className='container mx-auto flex max-w-7xl flex-col items-start gap-20 px-4 lg:flex-row'>
        ...
        >
          ...
          <div className='mb-8 flex space-x-4'>
            ...
            >
              <a
                href='https://firebasestorage.googleapis.com/v0/b/lacontroller-2b7de.appspot.com/o/reports%2Fidlefunds2026.pdf?alt=media&token=548fa4b8-25e0-4ce7-b6c4-ad8c1b161b0f'
                target='_blank'
