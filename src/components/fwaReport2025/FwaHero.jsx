      ...
      <div className='container mx-auto flex max-w-7xl flex-col items-start gap-20 px-4 lg:flex-row'>
        ...
        >
          ...
          <p className='mb-8 max-w-2xl text-xl text-gray-100'>
            2025 Annual Report of the City Controller’s Fraud, Waste, & Abuse
            Unit
          </p>

          <div className='mb-8 flex flex-wrap gap-4'>
            <a
              href='https://firebasestorage.googleapis.com/v0/b/lacontroller-2b7de.appspot.com/o/REMEDIATED%20PDFS%2FFWA%2FFWA_Annual_Report_2025_08.20.2026%20REM.pdf?alt=media&token=16f5c409-f8d8-4315-8251-7d33b52841c2'
              target='_blank'
        ...
        >
          <div className='relative h-[600px] w-[500px]'>
            <img
              src='https://firebasestorage.googleapis.com/v0/b/lacontroller-2b7de.appspot.com/o/Data%20Thumbnails%2Ffwa-annualreport2025.jpg?alt=media&token=4d0d3aef-adea-4f7d-a820-62a97b8528e6'
